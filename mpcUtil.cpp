...
long long crossEntropy(std::vector<long long int> trueValue, std::vector<long long int> predValue,
                       std::vector<long long int> trueValue1, std::vector<long long int> predValue1) {
